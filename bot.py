...
from fastapi.responses import JSONResponse, Response # Added Response for HEAD
...
class YouTubeBot:
    ...
    async def _handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            # --- FIX: Await the async download function directly --- 
            # Assuming self.downloader.download_video is now an async function
            # This replaces the previous loop.run_in_executor call which caused the TypeError
...
# --- FastAPI Routes ---
# --- FIX: Simplified GET/HEAD handling for root path health check ---
