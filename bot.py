...
import requests
import os
import asyncio # Added import for run_in_executor
from contextlib import asynccontextmanager
from functools import partial # Added for run_in_executor with arguments
...
class YouTubeBot:
    ...
    async def _handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            # --- FIX: Run synchronous download in executor --- 
